...
const app = new Vue({
    ...
    data:{
        displayresume:{
            ...
            statement:{
                content:'2018年6月毕业于苏州科技大学，在大学期间做了三年的微信公众号运营。大四期间在科锐国际一家上市猎头公司做了1个月的运营实习生，帮助团队推动即派项目的进行。毕业后五个月先后在一家网约车和一家电商运营公司做运营。工作五个月接触了前端，发现自己热爱技术。至今为止脱产自学前端半年，热爱写代码，享受通过各种代码组合做出想要成果的过程，享受解决bug的过程，享受创造的过程。'
            },
        },
        line:{
